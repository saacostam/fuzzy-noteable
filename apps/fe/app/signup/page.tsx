...
export default function SignUp(){
    ...
    const onSubmit = useCallback<SubmitHandler<SignUpForm>>(({username, email, password, confirmPassword}) => {
        // Form Validations
       if (password !== confirmPassword) return setError('confirmPassword', { message: "Passwords are different"});
        ...
        <div className="hero min-h-[calc(100vh-68px)]">
            <div className="card shrink-0 w-full max-w-sm shadow-2xl bg-base-100">
                <form className="card-body" onSubmit={handleSubmit(onSubmit)}>
                    ...
                    <span className="block mx-auto mb-2">Already a user? <Link className="link link-secondary font-bold" href={ROUTES.SIGN_IN}>Sign In</Link></span>
