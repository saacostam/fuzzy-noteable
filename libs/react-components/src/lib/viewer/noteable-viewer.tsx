  ...
  return (
    <main>
      <div className={"w-100 mx-auto flex flex-col md:flex-row"}>
        <canvas id={canvasId} width={1600} height={900} style={{backgroundColor: '#3E78B2'}} className="w-full md:w-2/3"/>
        <div className={'flex items-center justify-center bg-black w-full md:w-1/3'} ref={playerContainerRef}>
